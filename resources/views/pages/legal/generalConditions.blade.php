            ...
            <div class="wrap">
                <div class="markup markup-titles counters markup-lists links-underline links-blue">
                    ...
                    <ol class="counters-level-2">
                        <li>
                            The general terms and conditions apply to all legal actions and legal relationships between Irabu and the client, unless otherwise explicitly agreed upon in writing between both parties.
                        </li>
                        <li>
                            The client shall be deemed to have agreed tacitly with the exclusive applicability of these conditions with any order given orally, written, by telephone, by e-mail, by telex or by telefax or otherwise, regardless of a written confirmation of Irabu.
                        </li>
                        <li>
                        ...
                        <li>
                            Any purchase, payment or other terms and conditions of the client shall not apply, unless they have been accepted expressly in writing by Irabu, even if the conditions of the client exclude these conditions.
                        </li>
                        <li>
                        ...
                        <li>
                            The placing of an order or task with Irabu is valid as the acceptance of these general sales conditions, to be consulted on the Irabu website at <a href="https://irabu.dev/legal">https://irabu.dev/legal</a>.
                        </li>
                        <li>
                    ...
                    <ol class="counters-level-2">
                        ...
                        <li>
                            If no fixed price is agreed with regard to the execution of the work, Irabu will charge the hours spent and costs incurred monthly to the client on the basis of the agreed rates or the rates into force since the time of the agreement.
                        ...
                        <li>
                            Any complaint will be thoroughly investigated by Irabu if, at the risk of cancellation, it is
                            submitted by registered letter within 8 days after delivery of the goods and/or services.

                        </li>
                        <li>
                            Complaints of the client on the invoice received must be remitted to Irabu by registered letter within eight days, otherwise they are null and void. The written complaint must clearly
                    ...
                    <ol class="counters-level-2">
                        <li>
                            ...
                            <ol class="counters-lower-alpha">
                                ...
                                <li>
                                    The cancellation must take place before the delivery took place or before Irabu in any form or capacity has begun with the agreed work.
                                </li>
                                <li>
                    ...
                    <ol class="counters-level-2">
                        ...
                        <li>
                            Irabu will notify the client as soon as possible when a change by an intermediate party, because of a to be agreed upon change or supplement to the specifications, will affect the time of completion of the work.
                        </li>
                        <li>
                    ...
                    <ol class="counters-level-2">
                        ...
                        <li>
                            If exceeding the time limit (of delivery) takes place, Irabu will notify the client as soon as
                            possible.
                        </li>
                        <li>
                    ...
                    <ol class="counters-level-2">
                        ...
                        <li>
                            Business and software are, from the moment they have been made available by Irabu to the client, for his account and risk.
                        </li>
                    </ol>
                    ...
                    <ol class="counters-level-2">
                        ...
                        <li>
                            The client is responsible for the use and the correct application in his organisation of the equipment, the software and the services to be provided by Irabu.
                        </li>
                    </ol>
                    ...
                    <ol class="counters-level-2">
                        <li>
                            If the client fails to fulfil one of his obligations towards Irabu, requests the cessation of payment or is in a state of bankruptcy, Irabu has the right without further notice of default or judicial intervention being required, to dissolve, all or certain, at the choice of Irabu, agreements concluded with the client, without prejudice to other legal rights due to Irabu. All payments due shall become immediately due and payable.
                        </li>
                        <li>
                            When the client does not fulfil any obligations resting on him on the basis of these general conditions or an agreement concluded with Irabu, then Irabu, without prejudice to its other rights, is entitled to suspend the agreed work until the client complies with his obligations.
                        </li>
                    </ol>
                    ...
                    <ol class="counters-level-2">
                        <li>
                            The conditions mentioned under paragraph II are specific to all the work to be performed by Irabu for the benefit of the client relating to the development and maintenance of web sites and software on the basis of detailed specifications and functional requirements.
                        </li>
                        <li>
                    ...
                    <ol class="counters-level-2">
                        ...
                        <li>
                            Irabu is responsible for the correction of errors due to them. Authors improvements that results in changes, additions or omissions beyond our control, will be charged according to the current rates.
                        </li>
                    </ol>
                    ...
                    <ol class="counters-level-2">
                        <li>
                            Irabu will deliver the developed websites and/or software to the client in accordance with the specifications.
                        </li>
                        <li>
                        ...
                        <li>
                            The website/software is further deemed to have been accepted after acceptance by the client, or 8 days after the ready for use delivery if the client has not informed Irabu in writing about the defects, or after the repair of the reported defects.
                        </li>
                        <li>
                    ...
                    <ol class="counters-level-2">
                        <li>
                            In accordance with the legal provisions on artistic and industrial ownership, drawings, models, designs, and so on, all the sketches, designs, photos, pictures, web pages and web sites, banners, interpretations, concepts, solutions, software, etc…, designed by Irabu whatever the technique may be, are the property of Irabu. They should in no way be counterfeited or reproduced or distributed in anyway whatsoever. The reneging or the cession of the above must in no way, unless permitted expressly and in advance, be regarded as the right to ownership.
                        </li>
                        <li>
                            The designed website/software is the intellectual property of Irabu and as such protected by the law. The website/software can therefore not be transferred free of charge or with a considered title, in whatever form, in whole or in part, to any third party, subject to the express written permission of Irabu.
                        </li>
                        <li>
                        ...
                        <li>
                            All the elements and data provided by the client to Irabu are provided for inclusion in the website/software, including all texts, images, logos, graphics, photos, audio or video films and the updates are supposed to be and to remain the exclusive property of the client.
                        </li>
                        <li>
                        ...
                        <li>
                            The client indemnifies Irabu against all third-party complaints that would claim a right to intellectual property or other contradictory right to any of the elements or data provided under article 4.4.
                        </li>
                    </ol>
                    ...
                    <ol class="counters-level-2">
                        <li>
                            The conditions listed under paragraph III are valid specifically to all web hosting activities for the benefit of the client to be performed by Irabu. Web hosting refers to the putting out of a website on a webserver.
                        </li>
                        <li>
                    ...
                    <ol class="counters-level-2">
                        <li>
                            The conditions mentioned under paragraph IV are specifically valid to all activities to be carried out by Irabu for the benefit of the client concerning registration, transfer or trade domain names.
                        </li>
                        <li>
                    ...
                    <ol class="counters-level-2">
                        <li>
                            Since the award of the domain names on the internet depends on the express approval of the competent authority, Irabu is at no time responsible for any refusal. Also damages compensation do not exist.
                        </li>
                    </ol>
