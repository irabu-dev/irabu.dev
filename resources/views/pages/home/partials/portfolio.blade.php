<section id="portfolio" class="section">
    <div class="wrap-8 section">
        <div class="sm:spanx-4 | md:startx-2 md:spanx-3 md:-ml-32 md:mr-16">
            <a href="https://app.gorocket.co" class="is-left h-full" title="app.gorocket.co">
                {{ image('portfolio/gorocket.png') }}
            </a>
        </div>
        ...
        <div class="sm:startx-2 sm:spanx-3 | self-center">
            <div class="markup links-blue links-underline | sm:grid-text-right">
                ...
                <ul class="text-lg mt-8 inline-block">
                    <li><span class="icon fill-pink-dark">{{ svg('icons/far-angle-right') }}</span> <a href="https://my.artassistant.com" target="_blank" rel="nofollow noreferrer noopener">my.artassistant.com</a></li>
                </ul>
            </div>
        </div>
    </div> --}}
